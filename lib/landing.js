...
export const TESTIMONIALS = [
  {
    quote:
      "Equinex has made tracking group expenses so simple! No more confusion about who paid for what. Highly recommended!",
    name: "Abhishek",
  ...
  {
    quote:
      "Planning events means managing multiple vendors and group expenses. Equinex makes tracking and splitting costs incredibly simple!",
    name: "Pallavi",
  ...
  {
    quote:
      "Managing expenses with roommates used to be a headache. Equinex made it effortless and transparent for everyone!",
    name: "Rahul",
